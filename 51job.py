...
def coordinate():
    ...
    cur.execute("CREATE table company(select company_Id,company_Name,company_Scale,company_Area,company_Address FROM work where company_Scale not in ('少于50人') GROUP BY company_id,company_Address)")
